...
if args["model"] not in MODELS.keys():
    raise AssertionError(
        "The --model command line argument should be a key in the 'MODEL' dictionary ")

# Initialize the input image shape (224x224 pixels) along with
# the pre-processing function (this might need to be changed
# based on which model we use to classify out image)
inputShape = (224, 224)
...
# Loop over the predictions and display the top prediction on the image, and display the image to our screen
