...
ap.add_argument('-j', '--jobs', required=False, type=int, default=-1, help='# of jobs for k-NN distance(-1 uses all available core)')
...
# Initialize SimplePreprocessor and SimpleDatasetLoader and load data and labels from the disk,
...
# Print the information about memory consumption
